...
const Bullets = () => {
    ...
    const menuItemsOne = [
        ...
        { img: MenuImg1, id: 'product-category1', name: 'Патрони' },
        { img: MenuImg3, id: 'product-category2', name: 'Пневматичні патрони' },
        { img: MenuImg4, id: 'product-category3', name: 'Патрони Флобера' },
        { img: MenuImg5, id: 'product-category4', name: 'Стріли' }
    ];
