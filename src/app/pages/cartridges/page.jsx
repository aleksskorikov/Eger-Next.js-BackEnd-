...
import Menu from '@/components/Menu'; // Импортируем новый компонент
...
const Cartridges = () => {
    ...
    const menuItemsOne = [
        ...
        { img: MenuImg1, id: 'product-category1', name: 'Дробові патрони' },
        { img: MenuImg2, id: 'product-category2', name: 'Картеч' },
        { img: MenuImg3, id: 'product-category3', name: 'Кульові патрони' },
        { img: MenuImg4, id: 'product-category4', name: 'Нарізні' },
        { img: MenuImg5, id: 'product-category5', name: 'Гладкоствольні' }
    ];
