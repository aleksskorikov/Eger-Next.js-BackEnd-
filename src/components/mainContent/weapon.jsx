...
const WeaponSection = () => {
    ...
    const categories = [
        { image: Weapon, title: 'Зброя', link: '/pages/gun', items: ['Травматична зброя', 'Пневматична зброя', 'Зброя під патрон Флобер', 'Сигнально-шумова зброя', 'Метальна зброя'] },
        { image: Bullets, title: 'Набої', link: '/pages/bullets', items: ['Патрони', 'Релоадинг', 'Пневматичні патрони', 'Патрони Флобера', 'Стріли'] },
        { image: Accessories, title: 'Аксесуари', link: '/pages/accessories', items: ['Зберігання та транспортування', 'Чищення та догляд', 'Стрілецькі аксесуари'] },
        ...
        { image: Tool, title: 'Інструмент', link: '/pages/tools', items: ['Мультитули', 'Мачете', 'Сокири', 'Лопати', 'Пили', 'Спецінструмент'] },
        { image: Equipment, title: 'Екіпірування', link: '/pages/equipment', items: ['Бронежилети', 'Шоломи', 'Наколінники', 'Навушники', 'Окуляри', 'Підсумки'] },
        { image: Defense, title: 'Засоби самозахисту', link: '/pages/self-defense', items: ['Газові балончики'] }
    ];
